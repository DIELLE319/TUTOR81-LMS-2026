                ...
                <table bgcolor="#F7EFE4" border="0" cellspacing="0" cellpadding="0" class="buttonwrapper">
                    <tr>
                        <td align="center" height="50" style=" padding: 0 25px 0 25px; font-family: Arial, sans-serif; font-size: 20px; font-weight: bold;" class="button">
                            <h4 style="text-align: center; margin-bottom:5px;" >Questo è il tuo codice corso </h4>
                            <h4 style="text-align: center; margin-top:0; display: inline-block; padding: 15px; background-color: #FD765D; color:#F7EFE4;" > <?=$lpu_detail["learning_project_pwd"]?></h4>
