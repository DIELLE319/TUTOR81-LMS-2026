 ...
 * -----------------------------------------------------------------------------------------/
 * 24-ago-2015
 * File: pages/sections/classroom-courses-new.php 
...
?>
<div id="workspace">
    <form id="new-classroom-courses" class="form-horizontal">
...
<script>
    $('#new-classroom-courses').submit(function(e){
        e.preventDefault();
        $('#new-classroom-courses button[type="submit"]').prop('disabled', true);
        var this_form = $(this);
        $.post('manage/classroom.php',
            {
                op_type: 'add_classroom_course',
            ...
            function(data){
                if (data > 0) {
                    ...
                    $('#new-classroom-courses button[type="submit"]').prop('disabled', false);
                }
            }
        );
    });
