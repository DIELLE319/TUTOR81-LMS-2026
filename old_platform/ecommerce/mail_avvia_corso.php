                    ...
                    <tr>
                        <td height="50" style=" padding: 0 25px 0 25px; font-family: Arial, sans-serif; background-color: #fff; font-size: 14px; font-weight: bold;" class="button">
                            ...
                            <span> Il tuo referente per questo corso è: <b style="color: #00a7d0;"><?=$tutor_user["surname"]?> <?=$tutor_user["name"]?> - <?= strtolower($tutor_user["email"]) ?></b></span><br/>
                                <!--FIXME: DAVIDE FIX NOME AZIENDA CLIENTE-->
<!--                            <span> Acquirente: <b style="color: #00a7d0;">--><?//=$tutor["business_name"]?><!--</b></span>-->
                            </p>
                        </td>
                    </tr>
                </table>
    ...
    <tr>
        <td bgcolor="#fff" style=" font-family: Arial, sans-serif; font-size: 12px; line-height: normal;">
            <div style=" border: 15px;  border-style:  none solid none solid; padding: 15px ; border-color:#394263; ">
                <h2 style="text-align: center; color:#19AAD8; margin-bottom: 10px; font-weight: 400; ">
    ...
    <tr>
        <td align="left" bgcolor="#dddddd" style=" color: #394263 ; font-family: Arial, sans-serif; font-size: 12px; line-height: 18px;">
            <div style=" border: 15px;  border-style:  none solid none solid; padding: 15px ; border-color:#394263; ">
                <p style="color: #394263; letter-spacing: 0.01em;">Il tuo referente per questo corso può essere contattato per E-Mail scrivendo a <?=$tutor_company["business_name"]?><br />
                    <?=$tutor_company["address"]?>, <?=$tutor_company["city"]?><br />
                    E-Mail: <a href="mailto:<?=$tutor_company["email"]?>"><?=$tutor_company["email"]?></a>
                </p>
                ...
                <p style="letter-spacing: 0.01em;"> ASSISTENZA TECNICA: In ogni momento &egrave; possibile inviare una segnalazione anche tramite mail dal pulsante Richiedi Assistenza oppure scrivete a <a href="mailto:<?=$tutor_company["email"]?>"><?=$tutor_company["email"]?></a></p>
            </div>
        </td>
    </tr>
    <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="center" width="100%" style="padding: 0 20px; color: #fff;  background-color: #394263; font-family: Arial, sans-serif; font-size: 12px;">
                            <h3><?=$tutor_company["business_name"]?> - <?=$tutor_company["address"]?>, <?=$tutor_company["city"]?></h3>
                        </td>
                    </tr>
                </table>
            </div>
