...
// EDIT DEPARTMENT TYPE FOR ALL PRODUCT UNIT
	...
	else $res = $dep_obj->setDepartmentType($_REQUEST['id_dep_type'], $_REQUEST['short_desc_dep_type'], $_REQUEST['long_desc_dep_type']);
...
// EDIT DEPARTMENT FOR ONE PRODUCT UNIT
	...
	$dep_type = $dep_obj->getDepartmentsTypeByShortDescription($_REQUEST['short_desc_dep_type'], $_REQUEST['company_id']);
	if ($dep_type) $dep_type_id = $dep_type['id_dep_type'];
	else $dep_type_id = $dep_obj->addDepartmentType($_REQUEST['short_desc_dep_type'], $_REQUEST['long_desc_dep_type'], $_REQUEST['company_id']);
...
// LOAD SAFETY PRODUCT UNIT
 ...
 // LOAD SAFETY PRODUCT UNIT
	...
	require_once 'class_custom_category.php';
