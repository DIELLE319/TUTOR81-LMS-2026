                        ...
                        <tbody>
                          ...
                          <tr className="border-b border-gray-100">
                            ...
                            <td className="py-0.5">
                              <input 
                                type="text" 
                                className="w-full px-2 py-0.5 text-[12px] text-gray-700 border border-gray-400 rounded focus:outline-none focus:border-blue-400"
                          ...
                          <tr className="border-b border-gray-100">
                            ...
                            <td className="py-0.5">
                              <input type="text" className="w-full px-2 py-0.5 text-[12px] text-gray-700 border border-gray-400 rounded focus:outline-none focus:border-blue-400"
                            ...
                            <td className="py-1">
                              <div className="flex items-center gap-4 text-[12px] text-black">
                                <span className="flex items-center gap-1"><strong className="text-blue-700">Durata:</strong>
                                  <input type="number" className="w-14 px-1 py-0.5 text-[12px] text-gray-700 border border-blue-200 rounded focus:outline-none focus:border-blue-400 text-center"
                          ...
                          <tr className="border-b border-gray-100">
                            ...
                            <td className="py-0.5">
                              <input type="text" className="w-32 px-2 py-0.5 text-[12px] text-gray-700 border border-gray-400 rounded focus:outline-none focus:border-blue-400 font-bold text-red-600"
