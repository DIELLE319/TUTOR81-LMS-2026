...
<body>
    ...
    <div id="page-container">
        ...
        <section class="site-section site-section-light site-section-top themed-background-dark">
            <div class="container">
                <h1 class="text-center animation-slideDown"><i class="fa fa-arrow-right"></i> <strong>Accedi</strong></h1>
                <h2 class="h3 text-center animation-slideUp">Accedi alla piattaforma e gestisci i corsi!</h2>
            </div>
        </section>
        <!-- END Intro -->
